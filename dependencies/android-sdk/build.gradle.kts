...
repositories {
    ivy {
        ...
        patternLayout {
            ...
            artifact("[artifact]_[revision](-[classifier]).[ext]")
            artifact("[artifact]-[classifier](-[revision]).[ext]")
        }
        metadataSources {
            artifact()
        }
...
val androidEmulatorDestDir = File(sdkDestDir, "emulator")
...
unzipSdkTask("sdk-tools", "4333796"/*26.1.1*/, "", toolsOsDarwin)
...
unzipSdkTask("emulator", "5264690", "", toolsOsDarwin, prepareTask = prepareEmulator)
...
artifacts.add(androidEmulator.name, file("$androidEmulatorDestDir")) {
